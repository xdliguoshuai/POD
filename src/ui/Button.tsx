...
// Note: Radix UI Slot is not installed, simplifying for now to just standard button
// If needed I can install class-variance-authority but I'll write a simpler version first to avoid too many deps
// actually cva is great but let's stick to simple props for now to speed up without too many deps
// Wait, I didn't install cva. I'll use standard clsx logic.
