  ...
  const checks = [
    {
      ...
      valid: !results.some(
        (r) =>
          r.rule === "QUALITY_CHECK" &&
          (r.state === "reject" || r.state === "risk")
      ),
      warning: results.some(
        (r) => r.rule === "QUALITY_CHECK" && r.state === "risk"
      ),
    },
    {
      ...
      valid: !results.some(
        (r) =>
          (r.rule === "SIZE_LIMIT" || r.rule === "AREA_INVALID") &&
          r.state === "reject"
      ),
      warning: false,
    },
    {
      ...
      valid: !results.some(
        (r) => r.rule === "TECHNIQUE_LIMIT" && r.state === "reject"
      ),
      warning: false,
    },
    {
          ...
          >
            ...
            <span>
              {hasErrors
                ...
                : hasRisks
                ? "Design contains risks. Review suggested."
