  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <Select value={font} onValueChange={(val) => onChange({ font: val })}>
          <SelectTrigger>
      ...
      <div className="flex gap-4">
        <div className="flex-1 space-y-2">
          ...
          <div className="flex bg-muted/20 rounded-md p-1 border">
            <button className="flex-1 h-8 flex items-center justify-center rounded hover:bg-white hover:shadow-sm transition-all">
              <Bold size={16} />
            </button>
            <button className="flex-1 h-8 flex items-center justify-center rounded hover:bg-white hover:shadow-sm transition-all">
              <Italic size={16} />
