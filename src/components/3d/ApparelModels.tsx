...
const PrintArea = ({ position, rotation, hasDesign, isActive }: { position: [number, number, number], rotation: [number, number, number], hasDesign: boolean, isActive: boolean }) => {
...
export function TShirtModel({ color, showFrontDesign, showBackDesign, activeView }: ModelProps) {
  return (
    <group dispose={null}>
      {/* Torso */}
...
export function CrewneckModel({ color, showFrontDesign, showBackDesign, activeView }: ModelProps) {
  return (
    <group dispose={null}>
      {/* Body */}
      <mesh castShadow receiveShadow position={[0, 0, 0]}>
...
export function HoodieModel({ color, showFrontDesign, showBackDesign, activeView }: ModelProps) {
  return (
    <group dispose={null}>
      {/* Body */}
      <mesh castShadow receiveShadow position={[0, 0, 0]}>
