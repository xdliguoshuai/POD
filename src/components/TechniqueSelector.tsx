...
export default function TechniqueSelector({ value, onChange, product, area }: Props) {
  ...
  return (
    <Card className="shadow-none border-0 bg-transparent">
      <CardHeader className="px-0 pt-0 pb-4">
        <CardTitle className="text-sm font-medium uppercase tracking-wider text-muted-foreground">Technique</CardTitle>
      </CardHeader>
