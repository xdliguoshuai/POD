...
export const PRODUCTS: Product[] = [
  // T-Shirts
  {
    ...
    price: 39,
    description: 'The definitive blank for high-end brands. Crafted from 100% heavyweight organic cotton (240 GSM), this tee features a refined boxy fit, a tight-knit surface perfect for DTG, and double-needle stitching for durability.',
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    specs: ['100% Organic Cotton', '240 GSM Jersey', 'Pre-shrunk', 'Drop Shoulder'],
    isBestSeller: true,
  },
  {
    id: 't-shirt-vintage',
    ...
    price: 45,
    description: 'Achieve that lived-in look and feel from day one. Our Vintage Wash Tee undergoes a special pigment dye and enzyme wash process to create a soft, slightly faded aesthetic with unique character.',
  ...
  },
  {
    ...
    price: 42,
    description: 'Engineered for movement. This moisture-wicking blend offers superior breathability and stretch, making it ideal for activewear brands or modern streetwear collections.',
  ...
  // Crewnecks
  {
    ...
    price: 59,
    description: 'A structural masterpiece. Made from luxury French terry fleece (400 GSM), offering a heavy drape and a silhouette that stays sharp. Features ribbed side panels and minimal branding.',
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    specs: ['100% Cotton Face', '400 GSM', 'French Terry Loopback', 'Ribbed Panels'],
    isBestSeller: true,
  },
  {
    ...
    price: 65,
    description: 'Maximum comfort, modern silhouette. This fleece crewneck features an exaggerated drop shoulder and wide body for that trendy oversized look. Ultra-soft brushed interior.',
    ...
    images: ['https://images.unsplash.com/photo-1620799140408-ed5341cd2431?auto=format&fit=crop&w=800&q=80'],
    colors: [
  ...
  // Hoodies
  {
    ...
    name: 'Hoodie Luxe',
    price: 79,
    description: 'The ultimate canvas. Featuring a double-lined hood without drawstrings for a clean, minimalist aesthetic. Heavyweight fleece (450 GSM) ensures warmth and premium structure.',
  ...
  },
  {
    ...
    price: 85,
    description: 'A versatile essential. Premium metal zipper, split kangaroo pocket, and the same heavyweight fleece fabric as our Luxe pullover. Perfect for layering.',
    shortDescription: 'Metal Zipper • Heavyweight Fleece',
    image: 'https://images.unsplash.com/photo-1647773356066-6701b228b340?auto=format&fit=crop&w=800&q=80',
    images: ['https://images.unsplash.com/photo-1647773356066-6701b228b340?auto=format&fit=crop&w=800&q=80'],
    colors: [
      { name: 'Black', value: 'black', hex: '#000000' },
      { name: 'Heather Gray', value: 'gray', hex: '#D3D3D3' },
    ],
